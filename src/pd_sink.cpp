...
int pd_sink::request_power_from_capability(int index, int voltage, int max_current) {
    ...
    uint16_t header = pd_header::create_data(pd_msg_type_data_request, 1, spec_rev);
